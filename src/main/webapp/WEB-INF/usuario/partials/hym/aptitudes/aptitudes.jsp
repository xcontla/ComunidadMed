<%-- 
    Document   : aptitudes
    Created on : 30/05/2018, 04:57:35 PM
    Author     : UNAM
--%>
        ...
        <div>
            <div class="row text-center">
                ...
                <div class="span4 ">
                        ...
                        <a class="btn btn-warning" href="${pageContext.request.contextPath}/usuario/examen.dgoae#/finalHerreraYmontes"> Saltar a siguiente sección</a>
